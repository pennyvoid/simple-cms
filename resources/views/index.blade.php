        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <img src="{{asset('storage/'.$first_post->featured)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('storage/'.$first_post->featured)}}" class="link-image js-zoom-image">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <a href="{{route('single',['slug'=>$first_post->slug])}}">{{$first_post->title}}</a>
                                    </h2>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('storage/'.$second_post->featured)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('storage/'.$second_post->featured)}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('storage/'.$third_post->featured)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('storage/'.$third_post->featured)}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <h6 class="case-item__title text-center"><a href="{{route('single',['slug'=>$post->slug])}}">{{$post->title}}</a></h6>
                                </div>
                            </div>
                            @endforeach  
                        </div>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                            <h4 class="h1 heading-title">{{$network->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach ($network->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                    <img src="{{asset('storage/'.$post->featured)}}" alt="our case">
