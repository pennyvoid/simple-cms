            ...
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <div class="post__author author vcard">
                                ...
                                <a href="{{route('user.post',['id'=>$post->user->id])}}" class="post__author-link">{{$post->user->name}}</a>
                                </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{($post->user->avatar != 'default.jpg')?asset("storage/".$post->user->avatar) :asset('uploads/profile/default.jpg')}}" alt="Author" width="120px" height="120px">
                    </div>
                ...
                <div class="pagination-arrow">
                    @if ($prev)
                        <a href="{{route('single',['slug'=>$prev->slug])}}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                    ...
                    @if ($next)
                        <a href="{{route('single',['slug'=>$next->slug])}}" class="btn-next-wrap">
                        <div class="btn-content">
